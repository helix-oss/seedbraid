---
name: create-pr-with-merge
description: >-
  Create a PR and squash-merge it into target branch. Requires gh command.
  Use only when the user explicitly asks to create and merge a pull request.
